(function (global) {
  ...
  function buildMpPublicPromoHtml() {
    return (
      ...
      + 'Оценивайте, сравнивайте вкусы и не теряйте фильмы в вашем персональном списке просмотра.'
      + '</div>'
      + '<div class="what-is-v2-features">'
      + '<a href="/#landing-feat-watchlist" class="what-is-v2-feature what-is-v2-feature--link"><span class="feat-icon mp-icon" data-mp-icon="watchlist"></span> Watchlist</a>'
      + '<a href="/#landing-feat-plans" class="what-is-v2-feature what-is-v2-feature--link"><span class="feat-icon mp-icon" data-mp-icon="calendar"></span> Планы</a>'
      + '<a href="/#landing-feat-series" class="what-is-v2-feature what-is-v2-feature--link"><span class="feat-icon mp-icon" data-mp-icon="series"></span> Сериалы</a>'
      + '<a href="/#landing-feat-tickets" class="what-is-v2-feature what-is-v2-feature--link"><span class="feat-icon mp-icon" data-mp-icon="ticket"></span> Билеты</a>'
      + '<a href="/#landing-feat-groups" class="what-is-v2-feature what-is-v2-feature--link"><span class="feat-icon mp-icon" data-mp-icon="friends"></span> Группы</a>'
      + '<a href="/#landing-feat-stats" class="what-is-v2-feature what-is-v2-feature--link"><span class="feat-icon mp-icon" data-mp-icon="stats"></span> Статистика</a>'
      + '</div>'
